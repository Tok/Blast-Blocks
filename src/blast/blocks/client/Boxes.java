...
public final class Boxes {
    ...
    private static MeshData makeStretchedBox(final float w, final float h, final float d) {
    ...
    private static float[] getNormalsFor(final List<Dir> dirs) {
    ...
    private static float[] getNormals(final Direction direction, final float value) {
    ...
    private static int[] getTriangles(final int rows) {
